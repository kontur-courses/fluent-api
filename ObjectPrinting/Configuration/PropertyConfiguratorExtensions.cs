...
namespace ObjectPrinting.Configuration
{
    ...
    {
        public static PrintingConfig<TOwner> Exclude<TOwner, TProperty>(this IPropertyConfigurator<TOwner, TProperty> property)
        {
        ...
        public static PrintingConfig<TOwner> Trim<TOwner>(this IPropertyConfigurator<TOwner, string> property,
            int maxLength)
        {
