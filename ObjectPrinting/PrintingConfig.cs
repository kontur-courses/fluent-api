    ...
    public class PrintingConfig<TOwner>
    {
        ...
        private string PrintToString(object obj, int nestingLevel)
        {
            ...
            foreach (var propertyInfo in type.GetProperties())
            {
                ...
                if (TryApplyConfig(propertyInfo.PropertyType, propertyValue, out var result))
                    propertyValue = result;
                if (TryApplyConfig(propertyInfo, propertyValue, out result))
                    propertyValue = result;
        ...
        private bool TryApplyConfig(object key, object propertyValue, out object result)
        {
        ...
        private ImmutableDictionary<object, List<Delegate>> AddConfig(object key, Func<object, object> value)
        {
