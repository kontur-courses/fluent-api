...
namespace ObjectPrinting
{
    public static class TypePrintingConfigExtensions
    {
        ...
        public static PrintingConfig<TOwner> Using<TOwner>(this TypePrintingConfig<TOwner, long> propConfig,
            CultureInfo culture)
        {
        ...
        public static PrintingConfig<TOwner> Using<TOwner>(this TypePrintingConfig<TOwner, decimal> propConfig,
            CultureInfo culture)
        {
