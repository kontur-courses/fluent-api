    ...
    public class ListShould
    {
        ...
        public void PrintListCollection_WhenHaveNesting()
        {
            var list = new List<object>
                { 1, 2, 3, new List<int>() { 1, 2, 3 }, new List<string> { "a,e", "something" } };
        ...
        public void PrintListCollection_WhenHaveNestingDictionary()
        {
            ...
            AssertThatListContainCollection(list,
        ...
        public void PrintListCollection_WhenHaveNestingOtherIEnumerableCollection()
        {
            ...
            AssertThatListContainCollection(list,
                "[[1, 2, 3, 4], [2, 3, 5, 45, 4, 54], [1336, 1337, 1338]]"); //Cant repeat([[1, 2, 3, 4], [2, 3, 5, 5, 45, 4, 54, 54], [1336, 1337, 1338]]) because HashSet 
        }
        ...
        {
            var list = new List<object>
                { new Person() { Age = 22, Name = "Sirgey" }, new Person() { Age = 24, Height = 155, Name = "Anna" } };
            AssertThatListContainCollection(list,
                "[Person; Name = Sirgey; Age = 22; HaveCar = False, Person; Name = Anna; Height = 155; Age = 24; HaveCar = False]");
        }
